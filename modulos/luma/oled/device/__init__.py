...
from modulos.luma.core.device import device, parallel_device
from modulos.luma.core.virtual import character
from modulos.luma.oled.device.color import color_device
from modulos.luma.oled.device.greyscale import greyscale_device
import modulos.luma.core.error
import modulos.luma.core.framebuffer
from modulos.luma.core.bitmap_font import embedded_fonts
import modulos.luma.oled.const
...
class ws0010(parallel_device, character):
    ...
    .. versionadded:: 3.6.0
    """
    def __init__(self, serial_interface=None, width=100, height=16, undefined='_', font=None, selected_font=0, exec_time=1e-6 * 50, rotate=0, framebuffer="diff_to_previous", const=modulos.luma.oled.const.ws0010, **kwargs):
        ...
        if not supported:
            raise modulos.luma.core.error.DeviceDisplayModeError(
                "Unsupported display mode: {0} x {1}".format(width, height))
